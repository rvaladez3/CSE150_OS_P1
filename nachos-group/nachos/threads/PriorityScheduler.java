...
public class PriorityScheduler extends Scheduler {
	...
	private TreeSet<ThreadState> ree = new TreeSet<ThreadState>();
    }
	...
	public void waitForAccess(PriorityQueue waitQueue) {
		...
		this.unreachable.add(waitQueue);
		if(waitQueue.owner == this) {
			
			this.ResourceList.remove(waitQueue);
	...
	protected LinkedList<PriorityQueue> unreachable = new LinkedList<PriorityQueue>();
